...
def validate(config):
    schema = {
        'sanity': {'type': 'dict', 'required': True, 'schema': {
            'override': {'type': 'dict', 'required': True, 'schema': {
                'ipv4': {'allowed': [None, 'enable', 'disable'], 'nullable': True},
                'ipv6': {'allowed': [None, 'enable', 'disable'], 'nullable': True},
            }}
        }},
        'check': {'type': 'dict', 'required': True, 'schema': {
        ...
        'smtp': {'type': 'dict', 'required': True, 'schema': {
            ...
            'from_addr': {'type': 'string', 'required': True, 'empty': False,
                          'regex': r'.+?@.+\..+'},
            'to_addr': {'type': 'string', 'required': True, 'regex': r'.+?@.+\..+'},
            'username': {'required': True, 'type': 'string', 'nullable': True, 'empty': False},
            'password': {'required': True, 'type': 'string', 'nullable': True, 'empty': False},
            'exfil': {'type': 'dict', 'required': True, 'empty': False,'schema': {
                'filename': {'type': 'string', 'empty': False, 'required': True},
                'payload_mode': {'type': 'string', 'empty': False, 'required': True,
                                 'allowed': ['attachment', 'inline']}
            }},
            'message': {'type': 'string', 'empty': True, 'required': False, 'nullable': True},
            'subject': {'type': 'string', 'required': True, 'empty': False},
        }},
        'port': {'type': 'dict', 'required': True, 'schema': {
            'mode': {'type': 'string', 'allowed': ['top10', 'top100', 'all']},
            'ipv4_addr': {'type': 'string', 'required': True, 'empty': False,
                          'regex': r'^(\d{1,3}\.){3}\d{1,3}$'},
            'ipv6_addr': {'type': 'string', 'required': True, 'empty': False,
                          'regex': r'^[0-9a-fA-F:]+$'},
        ...
        'http': {'type': 'dict', 'required': True, 'schema': {
            'timeout': {'type': 'integer', 'required': True, 'min': 1},
            'exfil': {'type': 'dict', 'required': True, 'empty': False, 'schema': {
                'filename': {'type': 'string', 'required': True, 'empty': False}
            }},
            'verbs': {'type': 'list', 'required': True,
                      'allowed': ['GET', 'POST', 'PUT', 'PATCH', 'DELETE']},
            'urls': {'type': 'list', 'required': True, 'schema': {
                'type': 'string', 'regex': r'^http(s)?://.*$'
            }},
            'proxies': {'type': 'dict', 'required': True, 'schema': {
                'http': {'type': 'string', 'nullable': True,
                         'regex': r'^(http(s)?|socks5)://.+'},
                'https': {'type': 'string', 'nullable': True,
                          'regex': r'^(http(s)?|socks5)://.+'}
            }}
        }},
        'icmp': {'type': 'dict', 'required': True, 'schema': {
            'timeout': {'type': 'integer', 'required': True, 'min': 1},
            'exfil': {'type': 'dict', 'required': True, 'empty': False, 'schema': {
                'filename': {'type': 'string', 'empty': False, 'required': True},
            ...
            'target_hosts': {'type': 'list', 'required': True, 'schema': {
                'type': 'string', 'required': True, 'empty': False,
                'regex': r'^((\d{1,3}\.){3}\d{1,3}|[0-9a-fA-F:]+)$'
            }}
        }},
        'dns': {'type': 'dict', 'required': True, 'schema': {
            'timeout': {'type': 'integer', 'required': True, 'min': 1},
            'servers': {'type': 'list', 'required': True, 'schema': {
                'type': 'string', 'required': True, 'empty': False,
                'regex': r'^((\d{1,3}\.){3}\d{1,3}|[0-9a-fA-F:]+)$'
            }},
            'exfil': {'type': 'dict', 'required': True, 'empty': False, 'schema': {
                'filename': {'type': 'string', 'empty': False, 'required': True},
                'nameserver': {'type': 'string', 'required': True, 'empty': False,
                               'regex': r'^((\d{1,3}\.){3}\d{1,3}|[0-9a-fA-F:]+)$'},
                'domain': {'type': 'string', 'required': True, 'empty': False},
                'record_type': {'type': 'string', 'required': True, 'empty': False,
                                'allowed': ['A', 'AAAA', 'MX', 'TXT']},
                'max_chunks': {'type': 'integer', 'min': 1, 'required': True},
                'chunk_size': {'type': 'integer', 'min': 1, 'required': True}
            }},
            'queries': {'type': 'list', 'required': True, 'schema': {
                'type': 'dict', 'required': True, 'empty': False, 'schema': {
                    'record': {'type': 'string', 'required': True, 'empty': False},
                    'record_type': {'type': 'string', 'required': True, 'empty': False,
                                    'allowed': ['A', 'AAAA', 'MX', 'TXT']},
        ...
        'ftp': {'type': 'dict', 'required': True, 'empty': False, 'schema': {
            'timeout': {'type': 'integer', 'required': True, 'min': 1},
            'host': {'type': 'string', 'required': True, 'empty': False},
