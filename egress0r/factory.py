...
from egress0r.smtp import SMTPCheck
from egress0r.http_verbs import HTTPVerbsCheck
from egress0r.nameserver import DNSCheck, Query
from egress0r.port import PortCheck
from egress0r.icmp import ICMPCheck
from egress0r.ftp import FTPCheck
from egress0r.payload import ExfilPayload, DNSExfilPayload, SMTPExfilPayload
...
def build_dns(config, overrides=None):
    ...
    payload = None
    try:
        if all((config['exfil'].get('domain'),
